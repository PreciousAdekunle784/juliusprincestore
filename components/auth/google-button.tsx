...
export function GoogleButton({ next = "/account" }: { next?: string }) {
  ...
  return (
    <button
      type="button"
      onClick={signIn}
      className="w-full inline-flex items-center justify-center gap-2.5 border border-black/15 rounded-[3px] py-2.5 text-sm font-medium hover:border-ink transition-colors"
    >
